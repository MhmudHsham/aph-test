...
<link href="{!! url('public/assets/global/plugins/datatables/plugins/bootstrap/datatables.bootstrap-rtl.css') !!}" rel="stylesheet" type="text/css" />
@stop
            ...
            <div class="portlet-title">
                <div class="caption font-dark">
                    <span class="caption-subject bold uppercase">
                        <a class="btn btn-info" href="{{ url('/admin/journals/create') }}">Add New</a>
                    </span>
                </div>
                <div class="tools"> </div>
            </div>
                ...
                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                    ...
                    <tbody>
                        ...
                        <tr class="tr_{{ $one->id }}">
                            ...
                            <td>{{ $one->title }} </td>
                            <td><img width="80px" src="{{ url('public/uploads/journals') . '/' . $one->image }}" /></td>
                            <td>
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                            <a href="{{ url("/admin/journals/")."/".$one->id . "/edit" }}">
                                                <i class="fa fa-pencil-square-o"></i> Edit </a>
                                        </li>
                                        <li>
                                            <a data-id="{{ $one->id }}" class="delete-url" href="{{ url("/admin/journals/")."/".$one->id }}">
