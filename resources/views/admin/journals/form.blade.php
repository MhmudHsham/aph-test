        ...
        <div class="portlet light portlet-fit portlet-form bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-green sbold uppercase">Journal Details
                </div>
            </div>
            <div class="portlet-body">
                @if($id == 0)
                @php($action = url('/admin/journals'))
                @else
                @php($action = url('/admin/journals/'). "/" . $id)
                <input type="hidden" value="journals/{{ $id }}" id="show_link">
                @endif
                <!-- BEGIN FORM   -->
